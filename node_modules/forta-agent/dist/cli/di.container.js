...
function configureContainer(commandName, cliArgs) {
    ...
    var bindings = {
        ...
        cliVersion: awilix_1.asFunction(function () {
            try {
                var packageJsonPath = path_1.join(__dirname, "..", "..", "package.json");
                var packageJson = utils_1.getJsonFile(packageJsonPath);
        ...
        cache: awilix_1.asFunction(function (fortaKeystore) { return flat_cache_1.default.load('cli-cache', fortaKeystore); }).singleton(),
        ...
        description: awilix_1.asFunction(function (packageJson) { return packageJson.description; }).singleton(),
        agentId: awilix_1.asFunction(function (fortaConfig, agentName) {
            return fortaConfig.agentId || utils_1.keccak256(agentName);
        }).singleton(),
        chainIds: awilix_1.asFunction(function (packageJson) {
        ...
        keyfilePassword: awilix_1.asFunction(function (fortaConfig) {
        ...
        getKeyfile: awilix_1.asFunction(get_keyfile_1.default),
        decryptKeyfile: awilix_1.asFunction(decrypt_keyfile_1.provideDecryptKeyfile),
